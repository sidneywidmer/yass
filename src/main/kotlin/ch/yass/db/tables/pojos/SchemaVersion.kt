...
data class SchemaVersion(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: SchemaVersion = other as SchemaVersion
        if (this.versionRank === null) {
            if (o.versionRank !== null)
                return false
        }
        else if (this.versionRank != o.versionRank)
            return false
    ...
    override fun hashCode(): Int {
        val prime = 31
        var result = 1
        result = prime * result + (if (this.versionRank === null) 0 else this.versionRank.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("SchemaVersion (")
