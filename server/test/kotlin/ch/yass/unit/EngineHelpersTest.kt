...
class EngineHelpersTest {
    ...
    fun testUpcomingPositions() {
        ...
        val result2 = upcomingPositions(Position.NORTH, Position.EAST)
        assertTrue(result2.size == 2)
        assertTrue(!result2.contains(Position.EAST))
        ...
        val result4 = upcomingPositions(Position.NORTH, Position.WEST)
        assertTrue(result4.isEmpty())

        // Test case 5: Different lead position
        val result5 = upcomingPositions(Position.EAST, Position.SOUTH)
        ...
        assertTrue(result6[0] == Position.WEST)
        assertTrue(result6[1] == Position.NORTH)
        assertTrue(result6[2] == Position.EAST)
    }
}
