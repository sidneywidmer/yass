...
open class Trick(
     ...
     */
    val ID: TableField<TrickRecord, Int?> = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "")
     ...
     */
    fun hand(): HandPath = hand
    val hand: HandPath by lazy { HandPath(this, TRICK__FK_TRICK_ON_HAND, null) }
     ...
     */
    override fun where(condition: Condition?): Trick = Trick(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Trick = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Trick = where(DSL.notExists(select))
}
