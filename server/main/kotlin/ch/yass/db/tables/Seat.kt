...
open class Seat(
     ...
     */
    val ID: TableField<SeatRecord, Int?> = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "")
    ...
    override fun getReferences(): List<ForeignKey<SeatRecord, *>> = listOf(SEAT__FK_SEAT_ON_GAME, SEAT__FK_SEAT_ON_PLAYER)

    /**
     * Get the implicit join path to the <code>public.game</code> table.
     */
    fun game(): GamePath = game
    val game: GamePath by lazy { GamePath(this, SEAT__FK_SEAT_ON_GAME, null) }

    /**
     * Get the implicit join path to the <code>public.player</code> table.
     */
    fun player(): PlayerPath = player
    val player: PlayerPath by lazy { PlayerPath(this, SEAT__FK_SEAT_ON_PLAYER, null) }
     ...
     */
    override fun where(condition: Condition?): Seat = Seat(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Seat = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Seat = where(DSL.notExists(select))
}
