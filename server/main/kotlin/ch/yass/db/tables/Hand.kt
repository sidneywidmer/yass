...
open class Hand(
     ...
     */
    val ID: TableField<HandRecord, Int?> = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "")
     ...
     */
    fun game(): GamePath = game
    val game: GamePath by lazy { GamePath(this, HAND__FK_HAND_ON_GAME, null) }
     ...
     */
    override fun where(condition: Condition?): Hand = Hand(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Hand = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Hand = where(DSL.notExists(select))
}
