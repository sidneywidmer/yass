...
data class GameStateDSL(
    val players: List<PlayerDSL>,
    val hands: List<HandDSL>,
    val settings: GameSettingsDSL
)
...
data class GameSettingsDSL(val wcType: WinningConditionType, val wcValue: Int, val forcedDecks: List<List<Card>> = emptyList())
data class HandDSL(
    val trump: Trump,
    val gschobe: Gschobe,
